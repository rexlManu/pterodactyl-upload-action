...
module.exports = __nccwpck_require__(2982);
...
var utils = __nccwpck_require__(5557);
var settle = __nccwpck_require__(6432);
var buildURL = __nccwpck_require__(188);
...
var pkg = __nccwpck_require__(3241);
var createError = __nccwpck_require__(2917);
var enhanceError = __nccwpck_require__(6278);
var HttpsProxyAgent = __nccwpck_require__(3436);
...
var settle = __nccwpck_require__(6432);
var buildURL = __nccwpck_require__(188);
var parseHeaders = __nccwpck_require__(3979);
var isURLSameOrigin = __nccwpck_require__(3299);
var createError = __nccwpck_require__(2917);
var btoa = (typeof window !== 'undefined' && window.btoa && window.btoa.bind(window)) || __nccwpck_require__(3864);
...
module.exports = function xhrAdapter(config) {
  return new Promise(function dispatchXhrRequest(resolve, reject) {
    ...
    if (utils.isStandardBrowserEnv()) {
      var cookies = __nccwpck_require__(224);
...
var utils = __nccwpck_require__(5557);
var bind = __nccwpck_require__(6444);
var Axios = __nccwpck_require__(8582);
var defaults = __nccwpck_require__(2424);
...
axios.Cancel = __nccwpck_require__(6747);
axios.CancelToken = __nccwpck_require__(4176);
axios.isCancel = __nccwpck_require__(7048);

// Expose all/spread
axios.all = function all(promises) {
  return Promise.all(promises);
};
axios.spread = __nccwpck_require__(3342);
...
var Cancel = __nccwpck_require__(6747);
...
var defaults = __nccwpck_require__(2424);
var utils = __nccwpck_require__(5557);
var InterceptorManager = __nccwpck_require__(5926);
var dispatchRequest = __nccwpck_require__(2442);
...
var utils = __nccwpck_require__(5557);
var transformData = __nccwpck_require__(7402);
var isCancel = __nccwpck_require__(7048);
var defaults = __nccwpck_require__(2424);
var isAbsoluteURL = __nccwpck_require__(6462);
var combineURLs = __nccwpck_require__(2540);
...
var utils = __nccwpck_require__(5557);
var normalizeHeaderName = __nccwpck_require__(5099);
...
function getDefaultAdapter() {
  ...
  if (typeof XMLHttpRequest !== 'undefined') {
    ...
    adapter = __nccwpck_require__(2161);
  } else if (typeof process !== 'undefined') {
    // For node use HTTP adapter
    adapter = __nccwpck_require__(8953);
  }
  return adapter;
}
...
var debug = __nccwpck_require__(8237)('https-proxy-agent');
...
const axios = (__nccwpck_require__(1199)["default"]);
